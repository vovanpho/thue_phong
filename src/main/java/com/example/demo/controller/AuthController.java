...
import com.example.demo.securingweb.jsonwebtoken.JwtUtils;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok(
				new HeaderResponse(jwt, userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(), roles));
	}
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "admin":
					...
					break;
				case "mod":
					RoleEntity modRole = roleRepository.findByName(ERole.MODIFIER)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(modRole);
